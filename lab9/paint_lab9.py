...
eraser = pygame.transform.scale(pygame.image.load("kbtu/materials/eraser.png"), (40, 40))
cleaner = pygame.transform.scale(pygame.image.load("kbtu/materials/clean.png"), (40, 40))
pen = pygame.transform.scale(pygame.image.load("kbtu/materials/pen.png"), (40, 40))
