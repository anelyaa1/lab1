...
bg = pygame.image.load("kbtu/materials/AnimatedStreet.png") # фон игры

# фоновая музыка
pygame.mixer.music.load('kbtu/materials/background.wav')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("kbtu/materials/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("kbtu/materials/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('kbtu/materials/goldcoin.png')
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('kbtu/materials/treasure.png')
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        pygame.mixer.Sound('kbtu/materials/coin.mp3').play()
        NUM_OF_COINS += 1
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('kbtu/materials/crash.wav').play()
        time.sleep(1)
